...
<!--Que se diplaye una imagen de un cohete pequeño cuando clic en mismo cohete grande -->
    <img id="cohete" style="visibility:hidden;"  src="img/logos/coheteultimo.png" width="320"/>
...
<!--gif de un platillo volante-->
    <div id="ufo">
    	<img id="modificado" class="platillo" onClick="volverwiki2()"src="img/logos/ufotrans.gif">
    </div>
<!-- Planetas imagenes-->
...
<!-- le pongo mostrar el elemento cohete pequeño con mostrar (this) , class="temblor LE AGREGO EL TEMBLOR AL COHETE incluyendo id temblor,
 para que tiemble el cohete al ponerse encima, tambien que suene el audio y que suene el motor,muestre layer y desaparece barra lateral scroll-->
	<div id="axis2" onClick="ocultar();desaparecescroll()" class="ten"><img id="clicame" onClick="play();mostrarastronauta();show('capa');mostrar(this); return false;mostrar2();" class="temblor object boomerang multiple"  src="img/logos/coheteultimo.png"></div>
<!-- Satelites rotando y sonidos al clicar en ellos-->  
    ...
    <div id="sateliterotando2"><img src="img/logos/SateliteAnimada.gif" onClick="letras()"></div>
